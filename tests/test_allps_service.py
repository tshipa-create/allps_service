...
class TestAllpsService(unittest.TestCase):
    def setUp(self):
        # Mock the service_client.RequestClient class
        self.mock_client = MagicMock()
        AllpsService.get_client = MagicMock(return_value=self.mock_client)

    def test_get_client(self):
        # Ensure that get_client returns the same client instance
        client1 = AllpsService.get_client()
        client2 = AllpsService.get_client()
    ...
    def test_authenticate(self, mock_get_reply_code_and_message, mock_save_allps_response_to_snowflake):
        ...
        response_parser = AllpsService.authenticate()
        ...
        self.assertDictEqual(response_parser.response_dict, AllpsService._auth_response_parser.response_dict)
    ...
    def test_get_instalment(
        ...
        AllpsService.get_instalment(TEST_PROMISSORY_ID, TEST_INST_NUM)
    ...
    def test_edit_instalment(
        ...
        AllpsService.edit_instalment(TEST_PROMISSORY_ID, TEST_INST_NUM, TEST_EDIT_INSTALL_ACTION_DT)
    ...
    def test_get_method_name(self):
        ...
        method_name = AllpsService.get_method_name(xml_request)
